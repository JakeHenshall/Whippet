...
class Settings {
	...
	public function whippet_options_callback() {
		echo '<p class="whippet-subheading">' . esc_html_e( 'Select which performance options you would like to enable.', 'whippet' ) . '</p>';
	}
	...
	public function whippet_woocommerce_callback() {
		echo '<p class="whippet-subheading">' . esc_html_e( 'Disable specific elements of WooCommerce.', 'whippet' ) . '</p>';
	}
